...
public interface ISearchEngine
{
    ...
    Task<SearchResult> SearchAsync(string searchTerm, int maxResults, WorkflowProfile profile);
    ...
    Task<List<string>> SearchFilesAsync(string pattern, WorkflowProfile profile);
}